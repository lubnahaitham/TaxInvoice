...
urlpatterns = [
    ...
    # pos
    path('pos/list/', views.pos_list, name='pos_list'),
    ...
    # path('pos/seller/<int:id>/', views.pos_seller_create, name='pos_seller_create'),
    path('pos/buyer/', views.pos_buyer_create, name='pos_buyer_create'),
    path('pos/product/', views.pos_product_create, name='pos_product_create'),
]
